...
if uploaded_file is not None:
    ...
    if st.button("Generate Queries"):
        ...
        for query, results in search_results.items():
            ...
            if "extracted_info" in llm_response:  # Assuming your LLM responds with extracted information
                extracted_info.append({
                    "query": query,
                    "extracted_data": llm_response["extracted_info"]
                })
    ...
    try:
        ...
        if st.button("Generate Google Queries"):
            ...
            for query, results in google_search_results.items():
                ...
                # Store the extracted information
                if "extracted_info" in llm_response_google:  # Assuming your LLM responds with extracted information
                    extracted_google_info.append({
                        "query": query,
                        "extracted_data": llm_response_google["extracted_info"]
                    })
